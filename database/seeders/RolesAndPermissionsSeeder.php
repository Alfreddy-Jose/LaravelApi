...
class RolesAndPermissionsSeeder extends Seeder
{
        ...
        public function run(): void
        {
                ...
                $coordinadorRole->givePermissionTo([
                        ...
                        'lapso.ver',
                        'lapso.pdf',
                        'lapso.cambiar estado',
                        'trayecto.crear',
                        'trayecto.editar',
                        'trayecto.eliminar',
                        'trayecto.ver',
                        'unidad Curricular.crear',
                        'unidad Curricular.editar',
                        'unidad Curricular.eliminar',
                        'unidad Curricular.ver',
                        'unidad Curricular.pdf',
                        'Tipo Matricula.crear',
                        'Tipo Matricula.editar',
                        'Tipo Matricula.eliminar',
                        'Tipo Matricula.ver',
                        'Tipo Matricula.pdf',
                        'seccion.crear',
                        'seccion.editar',
