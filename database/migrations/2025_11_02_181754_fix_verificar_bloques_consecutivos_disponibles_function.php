...
class FixVerificarBloquesConsecutivosDisponiblesFunction extends Migration
{
    public function up()
    {
        // Primero: Eliminar la función existente (si existe)
        DB::statement('DROP FUNCTION IF EXISTS public.verificar_bloques_consecutivos_disponibles(bigint, bigint, text, bigint, integer, bigint, text, bigint);');

        // Segundo: Crear la nueva función con la firma corregida
        DB::statement('
    ...
    {
        // Primero: Eliminar la función corregida
        DB::statement('(DROP FUNCTION IF EXISTS public.verificar_bloques_consecutivos_disponibles(bigint, bigint, text, bigint, integer, bigint, text, bigint);');

        // Segundo: Recrear la función con la firma original
        DB::statement('
            CREATE OR REPLACE FUNCTION public.verificar_bloques_consecutivos_disponibles(
                p_espacio_id bigint,
                p_docente_id bigint,
