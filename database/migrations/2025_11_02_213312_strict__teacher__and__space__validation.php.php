...
class StrictTeacherAndSpaceValidation extends Migration
{
    public function up()
    {
        ...
        DB::statement('
            ...
            BEGIN
                ...
                -- VERIFICACIÓN 1: Conflictos de ESPACIO en mismo lapso/trimestre/día
                IF EXISTS (
                    SELECT 1 
                    FROM clases c
                ...
                -- VERIFICACIÓN 2: Conflictos de DOCENTE en mismo lapso/trimestre/día
                IF EXISTS (
                    SELECT 1 
                    FROM clases c
                    JOIN horarios h ON c.horario_id = h.id
                ...
                -- VERIFICACIÓN 3: Evitar dos clases en el MISMO HORARIO
                IF EXISTS (
                    SELECT 1 
                    FROM clases c
    ...
    public function down()
    {
        ...
        DB::statement('
            ...
            BEGIN
                ...
                -- Solo verificaciones básicas (sin restricción estricta de docente/espacio)
                IF EXISTS (
                    SELECT 1 
                    FROM clases c
                    WHERE c.horario_id = p_horario_id
